...
public final class SSTableTombstoneWriter implements Closeable
{
    ...
    private void rawAddRow(List<ByteBuffer> values) throws InvalidRequestException, IOException
    {
        ...
        List<ByteBuffer> keys = delete.buildPartitionKeyNames(options, QueryState.forInternalCalls());
        ...
        SortedSet<Clustering<?>> clusterings = delete.createClustering(options, QueryState.forInternalCalls());
        try
        {
            for (ByteBuffer key : keys)
            {
    ...
    public static class Builder
    {
        ...
        public SSTableTombstoneWriter build()
        {
            ...
            org.apache.cassandra.io.util.File cassFile = new org.apache.cassandra.io.util.File(directory);
            AbstractSSTableSimpleWriter writer = new SSTableSimpleUnsortedWriter(cassFile, ref,
        ...
        private DeleteStatement prepareDelete()
        {
            ...
            DeleteStatement delete = (DeleteStatement) deleteStatement.prepare(ClientState.forInternalCalls());
