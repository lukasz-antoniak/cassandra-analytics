...
class JoiningDoubleClusterTest extends JoiningSingleNodeTest
{
    ...
    {
        completeTransitionsAndValidateWrites(BBHelperDoubleClusterSize.transitionalStateEnd,
                                             singleDCTestInputs(),
                                             false);
    }
    ...
    protected ClusterBuilderConfiguration testClusterConfiguration()
    {
        return clusterConfig().nodesPerDc(5)
                              ...
                              .instanceInitializer(BBHelperDoubleClusterSize::install);
    }

    @Override
    protected CountDownLatch transitioningStateStart()
    {
        return BBHelperDoubleClusterSize.transitionalStateStart;
    }
